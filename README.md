...
1. Implement "extra" functions (see the [extras developer guide](https://python-fileformats.github.io/fileformats/developer/extras.html)) in `extras/fileformats/extras/vendor/<YOUR-VENDOR-NAME>/<YOUR-MIMELIKE-TYPE>.py`
...
[![CI/CD](https://github.com/python-fileformats/fileformats-vendor-CHANGEME/actions/workflows/ci-cd.yml/badge.svg)](https://github.com/python-fileformats/fileformats-vendor-CHANGEME/actions/workflows/ci-cd.yml)
[![Codecov](https://codecov.io/gh/python-fileformats/fileformats-vendor-CHANGEME/branch/main/graph/badge.svg?token=UIS0OGPST7)](https://codecov.io/gh/python-fileformats/fileformats-vendor-CHANGEME)
...
[![Documentation Status](https://img.shields.io/badge/docs-latest-brightgreen.svg?style=flat)](https://python-fileformats.github.io/fileformats-vendor-CHANGEME/)

The extension package of [Fileformats](https://github.com/python-fileformats/fileformats) provides a library of Python classes types for recognising and handling vendor-specific formats for CHANGEME files.
